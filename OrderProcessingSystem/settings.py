"""
Django settings for OrderProcessingSystem project.
...
SECRET_KEY = 'django-insecure-qnl0rbs^zm0au*wv4imvq9=fl0+7riq+3e0c_==$1*^ihs1j5c'
...
ROOT_URLCONF = 'OrderProcessingSystem.urls'
...
WSGI_APPLICATION = 'OrderProcessingSystem.wsgi.application'
